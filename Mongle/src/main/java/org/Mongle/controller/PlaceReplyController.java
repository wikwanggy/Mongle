...
public class PlaceReplyController {
	...
	// 댓글쓰기
	@RequestMapping(value = "/placereplies/new", method = RequestMethod.POST)
	...
	// 댓글목록리스트
	@RequestMapping(value = "/placereplies/{bno}", method = RequestMethod.GET)
	...
	// 댓글수정
	@RequestMapping(value = "/placereplies/modify", method = RequestMethod.PUT)
	...
	// 댓글삭제
	@RequestMapping(value = "/placereplies/remove/{rno}", method = RequestMethod.DELETE)

					...
					<form name="fomr1">
						<div id="box">
							<div id="cnt-header_right">
								...
								<div id="sum">
									<div id="number">
										<input type="text" id="sell_price" value="${main.w_price}">
										<input type="number" name="num" value="1" id="num" class="sum"
											max="${main.w_Quantity}" onchange="total()">

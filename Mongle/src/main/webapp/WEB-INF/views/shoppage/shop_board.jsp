...
<body>
	<form action="/shoppage/shop_board" method="post" id="form" enctype="multipart/form-data">
		<h1>상품 등록 게시판</h1>
		<table border="1">
			<tr>
				<td>상품 이름</td>
			...
			<tr>
				<td>상품 가격</td>
				<td><input type="text" name="w_price" placeholder="가격"></td>
			</tr>
			<tr>
				<td>상품 설명 사진 첨부</td>
			...
			<tr>
				<td>상품 종류</td>
				<td><input type="text" name="w_type" placeholder="종류"></td>
			</tr>
			<tr>
				<td>상품 수량</td>
				<td><input type="text" name="w_Quantity" placeholder="수량"></td>
			</tr>
		</table>

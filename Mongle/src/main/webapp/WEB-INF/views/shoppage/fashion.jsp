				...
				<div class="Goods">
					<ul class="Goodss">
						...
						<c:forEach items="${fashion}" var="fashion">
							<li>
								<div>
									<input type="text" value="${fashion.bno}" hidden="">
								</div>
								<div>
									<a href="/shoppage/Detail?bno=${fashion.bno}"> <img
										class="img" src="/display?filename=${fashion.filem}"></a>
								</div>
								<div>
									상품명<span class="font">${fashion.w_name}</span>
								</div>
								<div>
									가격<span class="font">${fashion.w_price}</span>
								</div>
								<div>
									<span>리뷰</span>
								</div>

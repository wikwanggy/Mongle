				...
				<div class="Goods">
					<ul class="Goodss">
						...
						<c:forEach items="${house}" var="house">
							<li>
								<div>
									<input type="text" value="${house.bno}" hidden="">
								</div>
								<div>
									<a href="/shoppage/Detail?bno=${house.bno}"> <img
										class="img" src="/display?filename=${house.filem}"></a>
								</div>
								<div>
									상품명<span class="font">${house.w_name}</span>
								</div>
								<div>
									가격<span class="font">${house.w_price}</span>
								</div>
								<div>
									<span>리뷰</span>
								</div>

				...
				<div class="Goods">
					<ul class="Goodss">
						...
						<c:forEach items="${etc}" var="etc">
							<li>
								<div>
									<input type="text" value="${etc.bno}" hidden="">
								</div>
								<div>
									<a href="/shoppage/Detail?bno=${etc.bno}"> <img
										class="img" src="/display?filename=${etc.filem}"></a>
								</div>
								<div>
									상품명<span class="font">${etc.w_name}</span>
								</div>
								<div>
									가격<span class="font">${etc.w_price}</span>
								</div>
								<div>
									<span>리뷰</span>
								</div>

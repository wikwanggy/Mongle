	...
	<div id="container">
		...
		<div id="service_main">
			...
			<span id="service_main_title">자주묻는 질문</span>
				...
				<div id="tab-5" class="service_faqlist current" >
			  ...
			  <c:choose>
				<c:when test="${sessionScope.login.id=='admin'}">
				 	<input id="questions_button" type="submit" value="1:1질문하러가기" style="cursor: pointer" onclick="location.href='/service/write?bgno=7'";>
				 </c:when>
				 <c:otherwise>
